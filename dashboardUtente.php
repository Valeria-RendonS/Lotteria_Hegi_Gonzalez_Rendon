...
// legge il ruolo dal db se l'utente è loggato
$ruolo = "ospite";
...
<head>
    ...
    <style>
        ...
        .disabled-card { opacity: 0.8; cursor: not-allowed; pointer-events: none; border: 2px dashed #cbd5e0; }
...
<div class="container">
                ...
                <div class="info-bar">
                    ...
                    <div class="stat" style="text-align: right;">
                        <?php if($l['tipo'] === 'esaurimento'): ?>
                            <span class="label">Biglietti mancanti</span><br>
                        ...
                        <?php else: ?>
                            ...
                            <span class="value timer" data-date="<?= $l['data_estrazione'] ?>">Calcolo...</span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
    ...
    <div class="lottery-list">
        <?php foreach($programmate as $l): ?>
            <div class="lottery-card disabled-card">
                <h3 style="margin-top:0"><?= htmlspecialchars($l['nome']) ?></h3>
                <p>Inizio vendite tra: <span class="timer" data-date="<?= $l['data_inizio_acquisti'] ?>">Calcolo...</span></p>
            </div>
        <?php endforeach; ?>
    </div>
</div>
...
<script>
    ...
    function updateTimers() {
        document.querySelectorAll('.timer').forEach(el => {
            ...
            } else { el.innerHTML = "In corso/Terminata"; }
        });
    }
